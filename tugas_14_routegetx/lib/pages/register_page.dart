  ...
  Widget build(BuildContext context) {
    ...
    void _register() async {
      ...
      if (password != confirmPassword) {
        _showMessage(context, 'Password dan konfirmasi password tidak sama!');
        return;
      }
      ...
      try {
        ...
        Get.toNamed(AppRoutesNamed.homePage);
        _showMessage(context, 'Registrasi berhasil! Selamat datang!');
